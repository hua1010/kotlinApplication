package com.toptech.warkeapplication.utils
...
object AppPrefsUtils {
    private var sp: SharedPreferences = MainApplication.mContext.getSharedPreferences(Constant.TABLE_PREFS, Context.MODE_PRIVATE)
    ...
    fun changeName(name: String){
        sp = MainApplication.mContext.getSharedPreferences(name, Context.MODE_PRIVATE)
        ed = sp.edit()
    }
